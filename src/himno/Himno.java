...
public class Himno {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("libertad, libertad, libertad");
        System.out.println("Oid el ruido de rotas cadenas");
        System.out.println("ved el trono a la nobre igualdad");
        System.out.println("Ya a su trono dignisimo abrieron");
        System.out.println("las provincias unidas de Sud");
        System.out.println("y los libres del mundo responde");
        System.out.println("al gran pueblo argentino salud.");
        System.out.println("Sean eterno los laureles");
